...
.login-box .canvaszz {
  width: 100%;
  background-image: url(../../assets/images/login/in_top_bj.png);
  height: 800px;
  position: absolute;
  z-index: 10;
...
.tit-bg {
  ...
  width: 90px;
  height: 1px;
  background: url(../../assets/images/login/login-tit.png);
}
.tit-bg.left {
  left: 0;
...
.login-box .signup a.gv {
  ...
  background: url(../../assets/images/login/nav_gv.png) repeat 0 0;
  width: 130px;
  height: 43px;
  display: inline-block;
  text-align: center;
...
.login-box .signup a.gv:hover {
  background: url(../../assets/images/login/nav_gv.png) repeat 0 -43px;
  color: #1d7eb8;
